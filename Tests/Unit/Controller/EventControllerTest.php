...
/**
 * Test case for class Tx_G40cloudfile_Controller_EventController.
 *
 * @version $Id$
 ...
 */
class Tx_G40cloudfile_Controller_EventControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**

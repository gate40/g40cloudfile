...
/**
 * Test case for class Tx_G40cloudfile_Controller_CategoryController.
 *
 * @version $Id$
 ...
 */
class Tx_G40cloudfile_Controller_CategoryControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**

...
/**
 * Test case for class Tx_G40cloudfile_Controller_FileController.
 *
 * @version $Id$
 ...
 */
class Tx_G40cloudfile_Controller_FileControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**

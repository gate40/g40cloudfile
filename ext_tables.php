...
t3lib_extMgm::addStaticFile($_EXTKEY, 'Configuration/TypoScript', 'Cloud File Manager');
			...
			t3lib_extMgm::addLLrefForTCAdescr('tx_g40cloudfile_domain_model_event', 'EXT:g40cloudfile/Resources/Private/Language/locallang_csh_tx_g40cloudfile_domain_model_event.xml');
			t3lib_extMgm::allowTableOnStandardPages('tx_g40cloudfile_domain_model_event');
			$TCA['tx_g40cloudfile_domain_model_event'] = array(
				'ctrl' => array(
					'title'	=> 'LLL:EXT:g40cloudfile/Resources/Private/Language/locallang_db.xml:tx_g40cloudfile_domain_model_event',
					'label' => 'name',
					'tstamp' => 'tstamp',
					'crdate' => 'crdate',
					'cruser_id' => 'cruser_id',
					...
					'iconfile' => t3lib_extMgm::extRelPath($_EXTKEY) . 'Resources/Public/Icons/tx_g40cloudfile_domain_model_event.gif'
				),
			);
